...
# %%
file ='/Volumes/T9/CSV_GOOGL_NASDAQ_PL/xnas-itch-20240906.mbp-10.csv'
...
fig.add_trace(go.Scatter(x=timy, y=np.array(counts_size)/np.array(counts), mode='lines', line=dict(color='red', width=2), name='Sizes extrêmes'))
