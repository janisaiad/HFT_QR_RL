...
# %%
files_csv = glob.glob(os.path.join("/Volumes/T9/CSV_GOOGL_NASDAQ_SL", "*.csv"))
...
# %%
visu_imbalance_respec(imb_tot, price_tot, 0 , 'add', 250000)
visu_imbalance_respec(imb_tot, price_tot, 1 , 'cancel', 250000)
...
visu_intensity_respec(imb_tot, intensity_tot, 2 , 'cancel', 100000)
