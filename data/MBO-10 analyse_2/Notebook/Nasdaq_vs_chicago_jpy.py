...
fig.update_layout(title=f'Chicago vs Nasdaq', xaxis_title='size', yaxis_title='intensity', showlegend=True)
fig.show()
...
fig.update_layout(title=f'Trade du bid queue ask et bid', xaxis_title='size', yaxis_title='taille de queue', showlegend=True)
fig.show()
...
fig.add_trace(go.Scatter(x = time, y = size_bid , mode ='lines', name ='bid', showlegend = True))
fig.add_trace(go.Scatter(x = time, y = size_ask , mode ='lines', name ='Ask', showlegend = True))
fig.update_layout(title=f'Trade du ask queue ask et bid', xaxis_title='size', yaxis_title='taille de queue', showlegend=True)
fig.show()
