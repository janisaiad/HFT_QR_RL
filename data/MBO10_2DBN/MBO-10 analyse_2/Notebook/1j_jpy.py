...
fig.add_trace(go.Scatter(x = time[::step], y = bid_px_00[::step], mode ='lines', name = 'Bid 0', showlegend = True))
fig.add_trace(go.Scatter(x = time[::step], y = ask_px_00[::step], mode ='lines', name = 'Ask 0', showlegend = True))
fig.add_trace(go.Scatter(x = time[::step], y = bid_px_01[::step], mode ='lines', name = 'Bid 1', showlegend = True))
fig.add_trace(go.Scatter(x = time[::step], y = ask_px_01[::step], mode ='lines', name = 'Ask 1', showlegend = True))
fig.add_trace(go.Scatter(x = time[::step], y = bid_px_02[::step], mode ='lines', name = 'Bid 2', showlegend = True))
fig.add_trace(go.Scatter(x = time[::step], y = ask_px_02[::step], mode ='lines', name = 'Ask 2', showlegend = True))
fig.add_trace(go.Scatter(x = time[::step], y = bid_px_03[::step], mode ='lines', name = 'Bid 3', showlegend = True))
fig.add_trace(go.Scatter(x = time[::step], y = ask_px_03[::step], mode ='lines', name = 'Ask 3', showlegend = True))
