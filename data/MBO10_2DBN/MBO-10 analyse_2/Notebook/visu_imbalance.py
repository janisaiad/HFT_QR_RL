...
def processing(file, output):
    ...
    while i < total_rows-1:
        ...
        if len(indices_group) > 1: # au moins 2 events au même moment
            ...
            if all_trades_then_cancel and complex_trades_cancels '''le and ne sert à rien mais on n'est pas sûr''' and no_new_limite: # erreur due pas à une new limite et qui est ue à un cancel
